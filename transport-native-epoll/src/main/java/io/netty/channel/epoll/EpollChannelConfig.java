...
public class EpollChannelConfig extends DefaultChannelConfig {
    ...
    public <T> boolean setOption(ChannelOption<T> option, T value) {
        ...
        if (option == EpollChannelOption.EPOLL_MODE) {
            setEpollMode((EpollChannelOption.EpollMode) value);
        } else {
    ...
    /**
     * Return the {@link EpollChannelOption.EpollMode} used. Default is
     * {@link EpollChannelOption.EpollMode#EdgeTriggered}. If you want to use {@link #isAutoRead()} {@code false} or
     * {@link #getMaxMessagesPerRead()} and have an accurate behaviour you should use
     * {@link EpollChannelOption.EpollMode#LevelTriggered}.
     */
    public EpollChannelOption.EpollMode getEpollMode() {
        return channel.isFlagSet(Native.EPOLLET)
                ? EpollChannelOption.EpollMode.EdgeTriggered : EpollChannelOption.EpollMode.LevelTriggered;
    }

    /**
     * Set the {@link EpollChannelOption.EpollMode} used. Default is
     * {@link EpollChannelOption.EpollMode#EdgeTriggered}. If you want to use {@link #isAutoRead()} {@code false} or
     * {@link #getMaxMessagesPerRead()} and have an accurate behaviour you should use
     * {@link EpollChannelOption.EpollMode#LevelTriggered}.
     *
     ...
     */
    public EpollChannelConfig setEpollMode(EpollChannelOption.EpollMode mode) {
        if (mode == null) {
